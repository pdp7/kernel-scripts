...
## ALWAYS READ 
1. Load `/home/pdp7/dev/review-prompts/kernel/technical-patterns.md`
...
- **KERNEL_REVIEW_PROMPTS_DIR**: /home/pdp7/dev/review-prompts/kernel
...
1. Load `/home/pdp7/dev/review-prompts/kernel/review-core.md`
...
1. Load `/home/pdp7/dev/review-prompts/kernel/debugging.md`
...
1. Load `/home/pdp7/dev/review-prompts/kernel/coccinelle.md`
...
context files from `/home/pdp7/dev/review-prompts/kernel/`:

1.  Always read `technical-patterns.md` before loading subsystem specific files

2. Read `/home/pdp7/dev/review-prompts/kernel/subsystem/subsystem.md` and load matching subsystem
